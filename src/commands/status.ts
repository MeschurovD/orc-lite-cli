...
import type { TaskStatus, QueueStatus } from '../types.js'

const TASK_STATUS_COLORS: Record<TaskStatus, (s: string) => string> = {
  pending: chalk.dim,
...
const QUEUE_STATUS_COLORS: Record<QueueStatus, (s: string) => string> = {
  pending: chalk.dim,
  in_progress: chalk.yellow,
  done: chalk.green,
  failed: chalk.red,
