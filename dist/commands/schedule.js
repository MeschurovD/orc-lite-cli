...
import { parseScheduleTime, formatScheduleTime, registerJob, cancelJob, cancelJobsForRepo, loadRegistry, getSchedulerPath, isDaemonRunning, getDaemonPid, } from '../core/scheduler.js';
export async function scheduleCommand(queueArg, timeArg, options) {
    // ── --list ────────────────────────────────────────────────────────────────
    if (options.list) {
        listJobs();
        return;
