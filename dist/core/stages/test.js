...
export async function runTestStage(ctx) {
    ...
    const prompt = buildTestPrompt(taskContent, implementOutput || '(нет вывода реализации)', gitDiff || '(нет изменений)', stageConfig?.prompt_template);
